<!doctype html>
<?php echo form_open('Login.php/login/');?>
<html lang="en">
   ...
   <div class="container">
     <div class="login-container">
       <div class="register">
         ...
         <form action="">
           <input type="text" placeholder="Matrícula" name="matricula" class="nombre" value="<?=set_value('matricula');?>" size="25" />
           
           <input type="password" placeholder="Contraseña" name="contraseña" class="pass" value="<?=set_value('contraseña');?>" size="25" />
           	<!-- inicio de sesion -->
